...
<h6>Details of purchase Report for <?php echo $_GET['monthof']." ".$_GET['year'] ;?> </h6>
</div>
<div class="page-btn">
...
<h1 style="text-align:center;text-transform:uppercase;">PURCHASE REPORT SUMMARY FOR <?php echo $_GET['monthof'];?>  <span id="currentyear"><?php echo $_GET['year'];?></span> </h1>
...
$enddate = $year."-".$month."-31";
  ...
  $select = mysqli_query($connection, "SELECT * FROM purchases WHERE date between '$startdate' and '$enddate'order by date desc ");
  if(mysqli_num_rows($select) < 1){
    echo "<script> alert('no record(s) found')
    history.back() </script>";
  }else{
